...
const SellerProfile = () => {
    ...
    const profileContent = profile ? (
        <div className="seller-content-wrapper">
            <div className="seller-profile-page">
                <div className="seller-profile-container">
                    <div className="seller-profile-header"></div>
                    ...
                    <div className="seller-edit-wrapper">
                        <div className="seller-details-section">
                            <div className="seller-image-wrapper">
                                ...
                                <label className="seller-edit-overlay">
                            ...
                            <div className="seller-info-section">
                                <div className="seller-field-row">
                                    <label className="seller-label">First Name:</label>
                                    <input
                                ...
                                <div className="seller-field-row">
                                    <label className="seller-label">Last Name:</label>
                                    <input
                                        className="seller-input"
                                        name="lastName"
                                ...
                                <div className="seller-field-row">
                                    <label className="seller-label">Birthday:</label>
                                    <input
                                        className="seller-input"
                                        type="date"
                                        name="birthday"
                        ...
                        <div className="seller-save-section">
                            <button className="seller-save-btn" onClick={handleSaveChanges}>
                                Save Changes
                            </button>
                        </div>
        ...
        <div className="seller-loading">{message || "Đang tải thông tin người dùng..."}</div>
    );
    ...
    return (
        <div className="seller-profile-layout">
            <SellerSidebar />
            <main className="seller-main-content">{profileContent}</main>
        </div>
    );
};
